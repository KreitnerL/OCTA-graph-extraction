...
then
    python /home/OCTA-graph-extraction/generate_analysis_summary.py --source_dir "$SRC_DIR" --output_dir "$OUTPUT_DIR" --faz_files "$OUTPUT_DIR/**/faz_*.png" --segmentation_dir "$SRC_DIR" "$@"
elif [ "$mode" = "pipeline" ]
then
